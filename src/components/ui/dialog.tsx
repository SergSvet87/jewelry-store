  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-[var(--main)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-9951 grid translate-x-[-50%] translate-y-[-50%] gap-4 p-5 shadow-none duration-200 sm:max-w-lg',
          className,
        )}
        {...props}
      >
